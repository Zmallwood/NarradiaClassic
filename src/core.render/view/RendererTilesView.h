    ...
    class RendererTilesView : public RendererBaseView, public Singleton<RendererTilesView> {
      public:
        ...
        void SetGeometryTile(
            ...
            Point3F &normal00, Point3F &normal10, Point3F &normal11, Point3F &normal01) const;
        void
        DrawTile(std::string_view image_name, RenderId vao_id, bool depth_test_off = false) const;
        void UpdateDrawTile(
      ...
      private:
        ...
        void SetGeometryImagePolygon(RenderId vao_id, std::vector<Vertex3F> &vertices) const;
