...
namespace Narradia
{
   ...
   void
   RendererBaseView::SetIndicesData(GLuint indices_vbo_id, int num_vertices, const void *data) const
   {
   ...
   void RendererBaseView::UpdateArrayBufferData(
       GLuint vbo_id, std::vector<float> &data, int num_floats_per_entry, int layout_location) const
   {
      glBindBuffer(GL_ARRAY_BUFFER, vbo_id);
   ...
   void RendererBaseView::UseVAOBegin(GLuint vao_id) const
   {
