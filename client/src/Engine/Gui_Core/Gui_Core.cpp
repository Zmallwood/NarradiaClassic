...
namespace Narradia {
...
#if 1
    GuiButton::GuiButton(
        const String_View &text, RectF bounds, Function<void()> action, String_View img_name,
        String_View hovered_img_name) {
        text_ = text;
        bounds_ = bounds;
        action_ = action;
        img_name_ = img_name;
    ...
    void GuiContainer::AddGuiComponent(Shared_Ptr<GuiComponent> comp) {
...
#if 1
    GuiWindow::GuiWindow(
        String_View title, RectF bounds, bool destroy_on_close, String_View background_image_name)
        : GuiMovableContainer(
    ...
    void SceneGui::AddGuiComponent(Shared_Ptr<GuiComponent> comp) {
        gui_components_->push_back(comp);
    }
    ...
    void GuiContainerV::AddGuiComponentView(Shared_Ptr<GuiComponentV> comp_view) {
    ...
    GuiWindowV::GuiWindowV()
        : gui_window_close_button_view_(Make_Shared<GuiWindowCloseButtonV>()) {
    ...
    void SceneGuiV::AddGuiComponentView(Shared_Ptr<GuiComponentV> comp_view) {
