...
namespace Narradia {
   ...
   auto MeshObtainer::ModelMeshIds(const aiScene *raw_model) const
      ...
      Map<SharedPtr<String>, Vector<int>> node_name_to_meshes;
      auto root_node = raw_model->mRootNode;
   ...
   auto ModelCreator::ModelParts(const aiScene *raw_model) {
      ...
      Vector<SharedPtr<ModelPart>> all_model_parts;
   ...
   auto ModelCreator::CreateModel(const aiScene *raw_model) -> SharedPtr<Model> {
