...
namespace Narradia {
...
#if 1
    class RendGrndV : public RendBaseV, public Singleton<RendGrndV> {
      public:
        RendGrndV();
        ~RendGrndV();
    ...
    void DrawTileSurface(String_View image_name, Render_ID vao_id, bool depth_test_off = false);
    inline void DrawTile(String_View image_name, Render_ID vao_id, bool depth_test_off = false) {
        auto vertex_count = 4;
