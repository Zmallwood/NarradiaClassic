...
// Models
    ...
    vec3 light_ambient = vec3(2.65, 2.65, 2.65)*3.0;
...
// Tiles
    ...
    class RendBaseV {
      ...
      protected:
        GLuint GetUniformLocation(String_View var_name);
        void CleanupBase();

        Shared_Ptr<RendBase> renderer_base_;
      ...
      private:
        ...
        void UpdateArrayBufferData(
            GLuint vbo_id, Vector<float> &data, int num_floats_per_entry,
            int layout_location) const;

        Shared_Ptr<ShaderProgramV> shader_program_view_;
    };
    ...
    class ShaderProgramV {
      ...
      private:
        ...
        Shared_Ptr<ShaderProgram> shader_program_;
    };
#endif
#endif
