...
namespace Narradia {
   // Keyframes
   // clang-format off
   auto nKeyframeCreator::PosKeyframe(
   ...
   // clang-format off
   auto nKeyframeCreator::RotKeyframe(
      const aiScene *_rawModel,
      String _nodeName,
   ...
   // clang-format off
   auto nKeyframeCreator::ScalKeyframe(
      const aiScene *_rawModel,
      String _nodeName,
      int _kframeIdx) const -> aiVectorKey {
      // clang-format on
   ...
   // Anim keyframes
   auto nKeyframeCreator::AnimPosKeyframes(const aiScene *_rawModel) const {
   ...
   auto nKeyframeCreator::AnimRotKeyframes(const aiScene *_rawModel) const {
   ...
   auto nKeyframeCreator::AnimScalKeyframes(const aiScene *_rawModel) const {
   ...
   // Node keyframes
   auto nKeyframeCreator::NodePosKeyframes(const aiScene *_rawModel, String _nodeName) const
       -> Vec<aiVectorKey> {
   ...
   auto nKeyframeCreator::NodeRotKeyframes(const aiScene *_rawModel, String _nodeName) const
       -> Vec<aiQuatKey> {
   ...
   auto nKeyframeCreator::NodeScalKeyframes(const aiScene *_rawModel, String _nodeName) const
       -> Vec<aiVectorKey> {
