...
namespace Narradia
{
   auto KeyframeCreator::PositionKeyframe(
       const aiScene *raw_model, std::string node_name, int keyframe_index) const -> aiVectorKey
   {
      auto node_position_keyframes = NodePositionKeyframes(raw_model, node_name);
   ...
   auto KeyframeCreator::RotationKeyframe(
       const aiScene *raw_model, std::string node_name, int keyframe_index) const -> aiQuatKey
   {
      auto node_rotation_keyframes = NodeRotationKeyframes(raw_model, node_name);
   ...
   auto KeyframeCreator::ScalingKeyframe(
       const aiScene *raw_model, std::string node_name, int keyframe_index) const -> aiVectorKey
   {
      auto node_scaling_keyframes = NodeScalingKeyframes(raw_model, node_name);
   ...
   auto KeyframeCreator::AnimPositionKeyframes(const aiScene *raw_model) const
   {
   ...
   auto KeyframeCreator::AnimRotationKeyframes(const aiScene *raw_model) const
   {
   ...
   auto KeyframeCreator::AnimScalingKeyframes(const aiScene *raw_model) const
   {
   ...
   auto
   KeyframeCreator::NodePositionKeyframes(const aiScene *raw_model, std::string node_name) const
       -> std::vector<aiVectorKey>
   {
      auto all_position_keyframes = AnimPositionKeyframes(raw_model);
   ...
   auto
   KeyframeCreator::NodeRotationKeyframes(const aiScene *raw_model, std::string node_name) const
       -> std::vector<aiQuatKey>
   {
      auto all_rotation_keyframes = AnimRotationKeyframes(raw_model);
   ...
   auto KeyframeCreator::NodeScalingKeyframes(const aiScene *raw_model, std::string node_name) const
       -> std::vector<aiVectorKey>
   {
      auto all_scaling_keyframes = AnimScalingKeyframes(raw_model);
